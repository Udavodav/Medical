                    ...
                    <div class="about-content">
                        ...
                        <div class="about-card">
                            ...
                            <div class="content">
                                ...
                                <p>Здесь вы найдете важную информацию о правилах оказания первой медицинской помощи и действиях в экстренных ситуациях. </p>
                            </div>
                        </div>
                        ...
                        <ul class="accordion">
                            <li class="accordion-item">
                                ...
                                <div class="accordion-content" style="display: none;">
                                    <p>
                                        Вам будет оказана квалифицированная медицинская помощь в соответствии с Медико-экономическими стандартами (МЭСами), разработанными Минздравом России. Это значит, что алгоритм работы с вами будет содержать только те назначения, которые необходимы для оптимальной диагностики и лечения вашего заболевания.                                    </p>
                                </div>
                            </li>
                            ...
                            <li class="accordion-item">
                                ...
                                <div class="accordion-content" style="display: none;">
                                    <p>
                                        Высокое качество нашего обслуживания не зависит от того, когда и к какому врачу вы пришли. Вы можете выбрать специалиста, исходя из его профиля и специализации, и быть уверены, что получите максимально квалифицированную помощь.                                    </p>
                                </div>
                            </li>
                            ...
                            <li class="accordion-item">
                                ...
                                <div class="accordion-content" style="display: none;">
                                    <p>
                                        Форма оплаты для частных лиц – любая (наличная, безналичная, по банковской карте). Для юридических лиц доступен только безналичный расчет. Оплата полной суммы единовременно.                                    </p>
                                </div>
                            </li>
                            ...
                            <li class="accordion-item">
                                ...
                                <div class="accordion-content" style="display: none;">
                                    <p>
                                        Записаться на приём возможно любым удобным способом: заполнить форму на сайте, позвонить по номеру телефона +7 (495) 266-77-63 или посетить наш центр, где администраторы подберут для Вас удобное время.                                    </p>
                                </div>
                            </li>
                            ...
                            <li class="accordion-item">
                                ...
                                <div class="accordion-content" style="display: block;">
                                    <p>
                                        Нет, записи о результатах всех осмотров и анализов, которые вы проходите в нашем центре, мы храним в электронной карте клиента. При необходимости мы сделаем из нее выписку - это бесплатно.                                    </p>
                                </div>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="testimonials-slider-area">
                        <div class="testimonials-slider owl-carousel owl-theme">
                            ...
                            <div class="testimonials-item">
                                <i class="flaticon-left-quote"></i>
                                <p>Прошел полное обследование в клинике Medical, результаты получил оперативно и врачи предложили наилучшее лечение.</p>
                                <div class="content">
                            ...
                            <div class="testimonials-item">
                                <i class="flaticon-left-quote"></i>
                                <p>Приятная атмосфера клиники Medical и отличный сервис - здесь действительно заботятся о пациентах.</p>
                                <div class="content">
                            ...
                            <div class="testimonials-item">
                                <i class="flaticon-left-quote"></i>
                                <p>Благодаря клинике Medical я быстро и безболезненно избавился от проблемы с зубами, рекомендую всем!</p>
                                <div class="content">
