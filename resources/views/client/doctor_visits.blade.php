    ...
    <section class="service-area pt-100 pb-70">
        ...
        <div class="container">
            ...
            <div class="row pt-45">
                ...
                <div class="container">
                    <a href="{{route('client.doctor_writes')}}" class="btn btn-success">Записи</a>
                    <a href="#" class="btn btn-primary">Посещения</a>
                    <div></div>
                </div>
        ...
        <!-- Modal -->
        <div class="modal fade" id="editVisit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editVisitForm">
                            @csrf
                            @method('PATCH')
                            <input type="text" name="visit_id" id="visit_id" class="d-none" value="">
                            <label for="inputFile" class="mx-2">Файл (.pdf)</label>
                            <div class="form-check my-2">
                                <input type="checkbox" class="form-check-input" onclick="showHide()" name="isChangeFile">
                                <label class="form-check-label" for="create-an-account">Прикрепить другой документ?</label>
                            </div>
                            <div class="input-group mb-3">
                                <input type="file" name="file" class="form-control mb-3" id="inputFile"
                                       aria-describedby="inputGroupFileAddon03" aria-label="Upload" style="visibility: hidden;">
                            </div>
                            ...
                            <div class="form-group my-3 mx-2">
                                <button type="submit" id="submitForm" class="btn btn-primary">Изменить</button>
        ...
        <script src="{{asset('dist/js/getVisits.js')}}"></script>
